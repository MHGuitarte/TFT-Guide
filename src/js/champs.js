        ...
        remote.getCurrentWindow().setTitle('Campeones');
        ...
        function loadByTier() {
            ...
            const ref = firebase.firestore().collection('champs').orderBy('tier', 'asc');
        ...
        function removeAllChilds(name) {
            ...
            let element = document.getElementById(String(name));
            console.log(element);
        ...
        //Default load is by id name
        loadByName();

        //Order handling
        document.getElementById('order_name').addEventListener('click', () => {

            removeAllChilds('col-0');
            removeAllChilds('col-1');
            removeAllChilds('col-2');

            loadByName();
        });

        document.getElementById('order_tier').addEventListener('click', () => {
